...
import 'package:flutter_screenutil_example/theming/my_font_weights.dart';

class MyStyles {
  static TextStyle font35MainBlueSemiBold = TextStyle(
    fontSize: 35.sp,
  ...
  static TextStyle font35MainBlueBold = TextStyle(
    fontSize: 35.sp,
